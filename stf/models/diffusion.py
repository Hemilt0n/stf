...
class GaussianDiffusion(nn.Module):
    def __init__(
        ...
        *,
        ...
        assert objective in {
            ...
            'pred_x0',
            'pred_residual'
        }, 'objective must be either pred_noise (predict noise) or pred_x0 (predict image start) or pred_residual (predict fine_img_02 - fine_img_01)'
    ...
    def p_losses(
        ...
        if self.objective == 'pred_noise':
            ...
            target = fine_img_02 - fine_img_01
        else:
