...
if __name__ == '__main__':
    # logger = get_logger(log_file='log/test2.log', log_level='INFO', file_mode='w')
    logger = FusionLogger('fusion', 'log/test.log', 'INFO')
    print(f"Logger level: {logger.getEffectiveLevel()}")  # 查看实际的日志级别
